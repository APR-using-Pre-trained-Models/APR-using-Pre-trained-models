...
def add_args(parser):
    parser.add_argument("--task", type=str, required=True,
                        choices=['summarize', 'concode', 'translate', 'refine', 'refine_tufano', 'refine_R4R', 'defect', 'clone', 'multi_task'])
    ...
    elif args.task in ['refine', 'refine_R4R', 'refine_tufano', 'concode', 'clone']:
        args.lang = 'java'
