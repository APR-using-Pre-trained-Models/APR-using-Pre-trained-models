...
from evaluator.accuracy import evaluate_accuracy_in_classes
...
def eval_bleu_epoch(args, eval_data, eval_examples, model, tokenizer, split_tag, criteria):
    ...
    if args.task in ['defect']:
        ...
        evaluate_accuracy_in_classes(eval_examples, pred_nls, args.nbest, args.task)
        with open(output_fn, 'w') as f, open(gold_fn, 'w') as f1, open(src_fn, 'w') as f2:
            for pred_nl, gold in zip(pred_nls, eval_examples):
        ...
        if args.task == 'summarize':
            ...
            if args.task in ['concode', 'translate', 'refine', 'refine_R4R', 'refine_tufano']:
