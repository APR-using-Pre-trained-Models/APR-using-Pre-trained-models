...
def get_filenames(data_root, task, sub_task, split=''):
    if task == 'refine_tufano':
        data_dir = '{}/{}/{}'.format(data_root, task, sub_task)
        if sub_task == 'cc':
          train_fn = '{}/train_CC_src.txt,{}/train_CC_tgt.txt'.format(data_dir, data_dir)
          dev_fn = '{}/valid_CC_src.txt,{}/valid_CC_tgt.txt'.format(data_dir, data_dir)
          test_fn = '{}/test_CC_src.txt,{}/test_CC_tgt.txt'.format(data_dir, data_dir)
        else:
          train_fn = '{}/train_C_src.txt,{}/train_C_tgt.txt'.format(data_dir, data_dir)
          dev_fn = '{}/valid_C_src.txt,{}/valid_C_tgt.txt'.format(data_dir, data_dir)
          test_fn = '{}/test_C_src.txt,{}/test_C_tgt.txt'.format(data_dir, data_dir)
...
def read_examples(filename, data_num, task):
    read_example_dict = {
        'refine_tufano' : read_tufano_examples,
        'refine_R4R': read_R4R_examples,
